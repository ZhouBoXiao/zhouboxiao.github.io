...
![image-20250525214702533](../img/posts/llm-study03/image-20250525214702533.png)
...
![image-20250525225910821](../img/posts/llm-study03/image-20250525225910821.png)

- LLM参数量和输入序列长度无关。对于有n层decode block块的LLM参数量为n(12h^2 + 13h)+Vh。当h较大时，可以忽略一次项，近视为12nh^2。
- 推理总需要内存约等于 1.2 x 模型参数内存（20%时经验，不同框架可能不一样）

![image-20250525230338124](../img/posts/llm-study03/image-20250525230338124.png)

![image-20250525230440953](../img/posts/llm-study03/image-20250525230440953.png)
...
![image-20250525231812680](../img/posts/llm-study03/image-20250525231812680.png)
...
AllReduce 的实现主要分为两个过程 Reduce-Scatter 和 All-Gather。**Reduce-Scatter** + **All-Gather** = **All-Reduce**
...
![image-20250525232936658](../img/posts/llm-study03/image-20250525232936658.png)
...
<img src="../img/posts/llm-study03/image-20250525233827133.png" alt="image-20250525233827133" style="zoom:80%;" />
...
<img src="../img/posts/llm-study03/image-20250525235132806.png" alt="image-20250525235132806" style="zoom: 67%;" />
